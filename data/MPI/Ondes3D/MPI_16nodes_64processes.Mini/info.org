...
#+DATE: Wed May  6 19:59:28 CEST 2015
#+AUTHOR: rktesser
...
#+BEGIN_EXAMPLE
oar      pts/0        2015-05-06 19:06 (fnancy.nancy.grid5000.fr)
#+END_EXAMPLE
...
TERM=screen
SHELL=/bin/bash
XDG_SESSION_COOKIE=e269614164fa3255281849b05534c7a4-1430931992.75130-1326839561
SSH_CLIENT=172.16.79.101 45495 6667
...
OARUSER=oar
OAR_JOB_NAME=
OAR_NODE_FILE=/var/lib/oar/611158
OAR_KEY=1
OAR_RESOURCE_PROPERTIES_FILE=/var/lib/oar/611158_resources
...
OAR_JOB_WALLTIME_SECONDS=35685
...
OAR_ARRAY_ID=611158
SUDO_COMMAND=OAR
OAR_FILE_NODES=/var/lib/oar/611158
SHLVL=2
HOME=/home/rktesser
LANGUAGE=en_US:en
OAR_ARRAYINDEX=1
OARXAUTHLOCATION=/usr/bin/xauth
OAR_JOB_WALLTIME=9:54:45
OAR_NODEFILE=/var/lib/oar/611158
LOGNAME=rktesser
SSH_CONNECTION=172.16.79.101 45495 172.16.65.1 6667
OAR_RESOURCE_FILE=/var/lib/oar/611158
LESSOPEN=| /usr/bin/lesspipe %s
OARDO_USER=oar
OAR_JOB_ID=611158
XDG_RUNTIME_DIR=/tmp/rktesser-runtime-dir
MYPREFIX=/home/rktesser/myprefix
OAR_CPUSET=/oar/rktesser_611158
OAR_ARRAY_INDEX=1
...
for host in `uniq $OAR_NODEFILE`; do echo "$host slots=$NPERNODE";done > $MFILE

export TRACEDIR="${MYDIR}/../trace.mpi.mini.64p.migration"
rm -rf "$TRACEDIR"
mkdir "$TRACEDIR"
cp ../configurations/essai-trace.prm ./DATA/essai.prm
echo "$TOPOLOGY" > topologie.in
mpirun -x MINI_TIME -x MINI_METRIC -x LD_LIBRARY_PATH -mca plm_rsh_agent /usr/bin/oarsh -machinefile machinefile -np $NP -npernode $NPERNODE ondes3d 2>&1 |tee $TRACEDIR/output.txt
